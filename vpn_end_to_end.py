...
def main_train(is_toy=False):
    ...
    if is_toy:
        ...
        generator.load_state_dict(torch.load(model_prefix%'38'))
        # torch.backends.cudnn.enabled = False
        print('Model 38 has been loaded')
...
def main_test(is_toy=False):
    ...
    res_file = 'models_' + prefix + '/vpn_end_to_end_p_results.txt'
    res = codecs.open(res_file, 'w')

    reply_file = 'models_' + prefix + '/vpn_end_to_end_p_reply.txt'
    reply_f = codecs.open(reply_file, 'w')

    ans_file = 'models_' + prefix + '/vpn_end_to_end_p_answer.txt'
...
if __name__ == '__main__':
    ...
    #     x_batch, x_v_batch, x_p_batch, x_n_batch, x_length, x_v_length, x_p_length, \
    #            x_n_length, go_y_batch, y_length, eos_map, eos_y_tag_batch = d.get_batch_test()
