...
class Seq2seq(object):
    ...
    def create_model(self):
        ...
        with tf.variable_scope('q_encoder'):
            ...
            tf.summary.histogram('query_state', query_state)
        ...
        with tf.variable_scope('kb_encoder'):
            ...
            tf.summary.histogram('kb_state', kb_state)
        ...
        with tf.variable_scope('reasoning'):
            ...
            def reasoning_process(i, q, cw, kb, all_last_m, all_last_c):
                ...
                all_last_m__ = all_last_m.write(i, m_i)
                all_last_c__ = all_last_c.write(i, c_i)
                return i + 1, q, cw, kb, all_last_m__, all_last_c__

            i_, q_, cw_, kb_, all_last_m_, all_last_c_ = control_flow_ops.while_loop(
            ...
            reasoning_output = tf.tanh(tf.concat([q_, all_last_m_.read(i_ - 1)], axis=-1))

            tf.summary.histogram('reasoning_output', reasoning_output)
